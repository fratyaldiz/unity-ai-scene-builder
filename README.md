...
Unity için AI destekli sahne tasarım aracı. Metin komutlarını (prompt) Claude API ile analiz eder, projedeki prefab'leri bulur ve Scene View'a mantıklı şekilde yerleştirir.
...
- Claude API'ye asenkron (async/await) HTTP isteği
...
- [ ] **Adım 2:** Prefab tarayıcı (`AssetDatabase` ile proje prefab listesi)
- [ ] **Adım 3:** JSON veri modelleri ve ayrıştırma
- [ ] **Adım 4:** Claude API istemcisi (async/await)
...
3. Claude API anahtarınızı girin ve komutunuzu yazın.
